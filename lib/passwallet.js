...
exports.loadRegistration = function (registration) {
	if ('undefined' === typeof registration.prototype.deviceLibraryIdentifier) {
		throw new Error('registration must have attribute "deviceLibraryIdentifier" to use passwallet module');
	}
...
exports.loadDevice = function (device) {
	if ('undefined' === typeof device.prototype.deviceLibraryIdentifier) {
		throw new Error('device must have attribute "deviceLibraryIdentifier" to use passwallet module');
	}
